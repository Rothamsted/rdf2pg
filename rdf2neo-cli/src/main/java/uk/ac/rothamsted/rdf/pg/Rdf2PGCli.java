package uk.ac.rothamsted.rdf.pg;
...
public class Rdf2PGCli
{
	...
	private static Logger log = LoggerFactory.getLogger ( Rdf2PGCli.class );
	...
	private static void printUsage ()
	{
		...
		out.println ( "\n\n *** Rdf2PG, the RDF-to-PropertyGraph converter ***" );
		out.println ( "\nConverts data from a Jena TDB database into a property graph" );
		
		out.println ( "\nSyntax:" );
		out.println ( "\n\trdf2pg.sh [options] <TDB path>" );		
