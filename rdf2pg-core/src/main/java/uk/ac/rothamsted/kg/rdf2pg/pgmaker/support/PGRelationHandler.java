...
/**
 * Similarly to {@link PGNodeHandler}, this is used by {@link PGMakerProcessor} to process
...
public abstract class PGRelationHandler extends PGEntityHandler<QuerySolution>
{
	 ...
	 * {@link PGNodeMakeProcessor#getNodeIrisSparql()}, so that such nodes, previously inserted in the target PG, can be 
	 ...
	 * 
	 * <p>This is used both by {@link PGRelationMakeProcessor}, to fetch all relations and their basic 
