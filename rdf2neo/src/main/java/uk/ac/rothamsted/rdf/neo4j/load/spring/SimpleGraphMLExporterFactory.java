...
import uk.ac.rothamsted.rdf.neo4j.load.SimpleGraphMLExporter;
 ...
 *
 * @author cbobed
 * <dl><dt>Date:</dt><dd>17 Apr 2020</dd></dl>
 *
 */
@Component
public class SimpleGraphMLExporterFactory implements ObjectFactory<SimpleGraphMLExporter>, ApplicationContextAware
{
	 ...
	 */
	@Override
	public SimpleGraphMLExporter getObject () throws BeansException
	{
		session.startSession ();
		return this.appCtx.getBean ( SimpleGraphMLExporter.class );
	}
